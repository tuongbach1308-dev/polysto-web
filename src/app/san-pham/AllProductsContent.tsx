...
export default function AllProductsContent({ products, categories }: Props) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [products, activeCategory, activeModel, priceRange, activeConditions, activeStorage, activeConnectivity, inStockOnly, sortBy]);
